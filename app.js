...
logger.debug(icingaConf);
logger.debug("############# Icinga Config End #########");
logger.debug("");
logger.debug("############# SNMP Settings #############");
logger.debug("SNMP Server: " + aditoServerAddrr);
logger.debug("SNMP Community: " + aditoSNMPCommunity);
logger.debug("SNMP Port: " + aditoSNMPPort);
